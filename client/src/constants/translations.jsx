export const translations = {
  en: {
    ...
    // App Modes (TOP TABS) – UPDATED NAMES
    appModeGenerator: "Commands & Scripts",
    appModeCompare: "Code Compare",
    ...
    explain: "Explain Command / Script",
    generating: "Generating...",
    explaining: "Explaining...",
    scripting: "Creating script...",
    ...
    aboutMeText:
      "I'm Amirhossein Yavari, an IT enthusiast passionate about building helpful tools. CCG is one of my projects to simplify command-line tasks, now part of Cando Academy.",
    aboutToolText:
      "CCG (Cando Command Generator) is an intelligent assistant that leverages a powerful AI to help you generate, understand, and debug command-line instructions.",

    footerLine1: "All rights reserved.",
    footerLine2: "Created by Amirhossein Yavari",
    footerCando: "Powered by Cando Academy",
    ...
    feedbackSubheader:
      "You've used CCG several times. Would you mind sharing your thoughts to help us improve?",
    ...
    // Smart Code Compare
    compareSubheader:
      "Compare two code snippets with AI to understand logical differences, review quality, and merge changes.",
    pasteCodeA: "Paste Code A (Original)",
    pasteCodeB: "Paste Code B (Modified)",
    compareWithAI: "Compare with AI",
    comparing: "Analyzing...",

    tabSideBySide: "Side-by-Side View",
  ...
  fa: {
    ...
    // تب‌های بالا – اسم جدید
    appModeGenerator: "کامندها و اسکریپت‌ها",
    appModeCompare: "مقایسه کد",
    ...
    errorPromptSubheader:
      "پیام خطا و زمینه آن را وارد کنید تا راه‌حل قدم‌به‌قدم دریافت کنید.",
    ...
    errorContextPlaceholder:
      "مثال: در حال کلون کردن یک ریپازیتوری گیت بودم که این خطا رخ داد...",
    ...
    aboutMeText:
      "من امیرحسین یاوری هستم، علاقه‌مند به دنیای IT و ساخت ابزارهای مفید. CCG یکی از پروژه‌های من برای ساده‌سازی کار با خط فرمان است که اکنون بخشی از Cando Academy است.",
    aboutToolText:
      "CCG (Cando Command Generator) یک دستیار هوشمند است که با استفاده از هوش مصنوعی قدرتمند به شما کمک می‌کند تا دستورات خط فرمان را تولید، درک و اشکال‌زدایی کنید.",

    footerLine1: "تمامی حقوق محفوظ است.",
    footerLine2: "ساخته شده توسط امیرحسین یاوری",
    footerCando: "با همکاری آکادمی کندو",
    ...
    errorParse:
      "پاسخ غیرمنتظره‌ای از هوش مصنوعی دریافت شد. لطفاً درخواست خود را با بیانی دیگر مطرح کنید.",
    ...
    feedbackSubheader:
      "شما چندین بار از CCG استفاده کرده‌اید. برای کمک به بهبود ابزار، نظر خود را با ما در میان می‌گذارید؟",
    feedbackAction: "ثبت بازخورد",
    feedbackDismiss: "بعداً",
    feedbackButton: "بازخورد",

    // Smart Code Compare
    compareSubheader:
      "دو قطعه کد را با هوش مصنوعی مقایسه کنید تا تفاوت‌های منطقی، کیفیت و تغییرات را درک کنید.",
    pasteCodeA: "کد A (نسخه اصلی)",
    pasteCodeB: "کد B (نسخه تغییریافته)",
    compareWithAI: "مقایسه با AI",
    comparing: "در حال تحلیل...",

    tabSideBySide: "نمای کنار هم",
