...
const Form = ({ mode, setMode, onSubmit, isLoading, lang }) => {
    ...
    const currentModeData = {
        generate: { label: t.questionLabel, placeholder: t.questionPlaceholder, button: t.generate, subheader: t.generateSubheader },
        explain: { label: t.commandLabel, placeholder: t.commandPlaceholder, button: t.explain, subheader: t.explainSubheader },
        script: { label: t.taskLabel, placeholder: t.taskPlaceholder, button: t.generateScript, subheader: t.scriptSubheader },
    };
