            ...
            <Card lang={lang}>
                ...
                <div
                    className="prose prose-sm dark:prose-invert 
                               text-gray-700 dark:text-gray-300 max-w-none"
            ...
            <Card lang={lang}>
                <div className="flex justify-between items-center mb-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-1 text-sm text-amber-600 dark:text-amber-400 hover:text-amber-700 transition-colors"
                    >
