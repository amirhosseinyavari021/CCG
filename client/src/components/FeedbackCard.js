    ...
    if (submitSuccess) {
        return (
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                <div className="bg-green-100 text-green-800 rounded-lg shadow-xl max-w-md w-full p-6 text-center">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-800 rounded-lg shadow-xl max-w-md w-full p-6">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-cyan-400">{currentTranslations.feedbackTitle}</h2>
                    <button
                        onClick={onClose}
                ...
                <p className="text-gray-300 mb-4">{currentTranslations.feedbackDescription}</p>
                    ...
                    <div className="flex space-x-1">
                        {[1, 2, 3, 4, 5].map((star) => (
                            <button
                                ...
                                className={`text-2xl ${star <= rating ? 'text-yellow-500' : 'text-gray-500'}`}
                                disabled={isSubmitting}
                            >
                                ★
                            </button>
                ...
                <div className="mb-4">
                    <label htmlFor="feedback-comment" className="block text-sm font-medium text-gray-300 mb-1">
                    ...
                    <textarea
                        ...
                        className="w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 border-gray-600 bg-gray-700 text-white"
                        rows="3"
                        disabled={isSubmitting}
                    />
                </div>
                ...
                <div className="flex justify-end space-x-2">
                    <button
                        type="button"
                        onClick={onClose}
                        className="px-4 py-2 text-sm bg-gray-700 text-gray-300 rounded-md hover:bg-gray-600 disabled:opacity-50"
                        disabled={isSubmitting}
                    >
