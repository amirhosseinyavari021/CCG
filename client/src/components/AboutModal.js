            ...
            <div className="bg-gray-800 rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                <div className="p-6">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-2xl font-bold text-cyan-400">{currentTranslations.about}</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="prose prose-sm dark:prose-invert text-gray-300">
                        ...
                        <p>{currentTranslations.website}: <a href="https://cmdgen.onrender.com" className="text-cyan-400 hover:underline">https://cmdgen.onrender.com</a></p>
                        <p>{currentTranslations.sourceCode}: <a href="https://github.com/amirhosseinyavari021/ay-cmdgen" className="text-cyan-400 hover:underline">https://github.com/amirhosseinyavari021/ay-cmdgen</a></p>
