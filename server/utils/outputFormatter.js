...
export function formatOutput(input, opts = {}) {
  ...
  if (parsed && isObj(parsed)) {
    ...
    const pythonScript = s(
      isPythonMode
        ? (
            (typeof src.pythonScript === "string" ? src.pythonScript : "") ||
            (typeof src.python_script === "string" ? src.python_script : "") ||
            (typeof src.script === "string" ? src.script : "") ||
            src?.primary?.command ||
            src.command
          )
        : (
